...
\newpage\ex{}{El dato inicial del algoritmo es el vector $B_0=\begin{pmatrix} 132 \\ 28 \end{pmatrix} $.
	\begin{itemize}
		...
		\item En el segundo paso, a partir de $28=1\times 20+8$, cambiamos los datos del algoritmo a $B_2=\begin{pmatrix} 20\\8 \end{pmatrix} $, queda:$$B_2=\begin{pmatrix} 0&1\\1&-1 \end{pmatrix}\begin{pmatrix} 28\\20 \end{pmatrix}=\begin{pmatrix} 0&1\\1&-1 \end{pmatrix}\begin{pmatrix} 0 & 1\\1&-4 \end{pmatrix}\begin{pmatrix} 132\\28 \end{pmatrix}  $$
...
\begin{myproof}
	...
	\end{enumerate}
\end{myproof}
\cor{}{Sea $n=p_1^{e_1}p_2^{e_2}\dots p_k^{e_k}$, con $p_i$ primos distintos y $e_i\in\mathbb{Z}^+$. Entonces:
\begin{enumerate}
...
\end{enumerate}
\end{myproof}
\mprop{}{Si $(G,*,e)$ es un grupo y $g\in G$ entonces $$|\langle g\rangle |=o(g)$$}
\begin{myproof}
...
\end{myproof}
\cor{}{sea $G$ un grupo de orden finito, entonces:
\begin{enumerate}
...
\end{myproof}
\cor{}{Si $(G,*,e)$ es un grupo de orden finito y $g\in g$ tenemos que
\begin{enumerate}
    \item $o(g)\ |\ |G|$.
    \item $g^{|G|}=e$.
